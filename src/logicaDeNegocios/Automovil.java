...
//Metodos get y set	
	...
	public void setCosto() {
		...
		Costo = (int)(Math.random()*3000+7000);
	}
	...
	public String getDueno() {
		return Dueno;//Salida:String con el nombre del due�o
	}
	
	public void setDueno(String dueno) {
		Dueno = dueno;//Entrada:String con el nombre del due�o
	}
	...
	int traccion = (estado * cilindrada ) + (pInclinacion * 980);
	}
}
